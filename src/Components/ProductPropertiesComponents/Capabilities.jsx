...
const Capabilities = ({ specialCapabilities }) => {
  return (
    <div className="p-1 w-[100%] h-[100%] flex  items-center flex-col justify-center">
      ...
      <div className="flex sm:justify-start sm:h-[350px] sm:ml-3 justify-center mt-[50px] w-[100%] flex-wrap overflow-y-scroll scrollbar-hide">
        {specialCapabilities?.map((elm) => {
          return (
            <div className="sm:w-[23%] w-[80%] sm:mt-3 mt-7 h-[320px] shadow-lg  transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 cursor-pointer sm:ml-7">
              <div className="w-[100%] h-[60%]  flex justify-center items-center">
                <div className="h-[87%] shadow-md w-[90%] bg-white rounded-[19px]">
                  <img src={elm?.image} alt="" className="h-[100%] w-[100%] " />
                </div>
              </div>
              <div className="w-[100%] h-[35%]  flex flex-col justify-center pl-3">
                ...
                <p
                  className="font-[400] mt-1 w-[92%] text-[12px] h-[170px]  overflow-y-scroll scrollbar-hide"
                  style={{ fontFamily: "Roboto" }}
                >
                  {elm?.description}
                </p>
